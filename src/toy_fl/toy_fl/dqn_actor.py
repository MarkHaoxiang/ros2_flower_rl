...
from flwr.common.typing import Config, Scalar, GetParametersIns, GetParametersRes, FitIns, FitRes
...
class DqnActor(RosKittenClient):
    def __init__(self, *args, **kwargs):
        assert (knowledge := kwargs.get("knowledge", None)) is not None \
            and isinstance(knowledge, DQNKnowledge)
