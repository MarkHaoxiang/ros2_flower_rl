...
class FeatureLabelPair(msg.FeatureLabelPair):
    ...
    """
    @staticmethod
    def build(feature: Tensor | FloatTensor,
              label: Tensor | FloatTensor) -> FeatureLabelPair:
        """
    ...
    def pack(self) -> msg.FeatureLabelPair:
        return msg.FeatureLabelPair(feature=self.feature.pack(),label=self.label.pack())
